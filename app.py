...
with tab1:
    ...
    exercise_angina=st.selectbox("Exercise_Induced Angina",["Yes","No"])
    old_peak=st.number_input("Oldpeak (ST Depression)", min_value=0.0, max_value=10.0)
    ...
    algonames=['Decision Trees','Logistic Regresion','Support Vector Machine','GridRandom']
    modelnames=['DecisionTree.pkl','LogisticR.pkl','RandomForest.pkl','SVM.pkl','gridrf.pkl']
...
with tab2:
    ...
    st.info("""
        ...
        4. Feature values conventions:\n
            ...
            - ChestPainType: chest oain type [3: Typical Angina, 0: Atypical Angine, 1: Non-Anginal Pain,2:Asymptomatic]\n
            -RestingBP: resting blood pressure [mm Hg]\n
            -Cholesterol: serum cholesterol [mm Hg]\n
            -FasitngBS: fasting blood sugar [1: if FastingBS > 120 mg/dl, 0:otherwise ]\n
            -RestingECG: resting electrocardiogram results [0: Normal, 1: having ST-T wave abnormality (T wave inversion),2:Left Ventricular Hypertrophy]\n
            -MaxHR : maximumm heart rate achievd [Numeric value between 60 and 202]\n
            -ExerciseAngina: exercise-induced angina [1:yes, 0: No]\n
            -Oldpeak: oldpeak = ST [Numeric value measured in depression]\n
            -ST-Slope: the slope of the peak exercise ST segment [0: upsloping, 1: flat, 2: downsloping]\n
    ...
    if uploaded_file is not None:
        ...
        if set(expected_columns).issubset(input_data.columns):
            ...
            #for i in range(len(input_data)):
               ...
               # input_data.loc[i,'Prediction LR'] = str(model.predict([arr])[0])
            ...
            #convert a button to download the updated CSV file
